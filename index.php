...
<div class="container">
    ...
    <div class="modal-content">
        ...
        <div class="about-section">
            ...
            <span class="close">&times;</span>
                <img src="picture/jonnie.jpg" alt="Image 1">
                <div class="image-description">
                    <p>Jonnie G. Escario Jr.</p>
                    <p>Calanigan Norte, Santo Tomas, Isabela</p>
                    <p>BSIT 2B</p>
                </div>
            </div>
            <!-- Image 2 with description -->
            <div class="about-image">
                <img src="picture/echo.jpg" alt="Image 2">
                <div class="image-description">
                    <p>Jericho L. Abaya</p>
            ...
            <div class="about-image">
                <img src="picture/jesus.jpg" alt="Image 3">
                <div class="image-description">
                    <p>Jesus Vacunawa</p>
                    <p>Cabagan Isabela</p>
                    <p>BSIT 2B</p>
